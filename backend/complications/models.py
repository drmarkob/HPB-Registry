...
class BaseComplication(models.Model):
    """Base complication model"""
    surgical_procedure = models.ForeignKey(
        SurgicalProcedure, 
        on_delete=models.CASCADE, 
        related_name='%(class)s_complications'
    )
...
class GeneralComplication(BaseComplication):
...
class PancreaticComplication(BaseComplication):
...
class LiverComplication(BaseComplication):
